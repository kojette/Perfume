    ...
    <section className="py-24 px-6 bg-gradient-to-br from-[#2a2620] via-[#3a3530] to-[#2a2620] text-white relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
          ...
          />
          <button className="px-10 py-4 bg-[#c9a961] text-[#2a2620] hover:bg-[#d4af37] transition-all duration-300 tracking-[0.3em] text-sm relative overflow-hidden group cursor-pointer">
